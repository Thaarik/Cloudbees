...
const UserListCard = ({ user }) => {
  return (
    ...
    <Link
      ...
      >
        <div className="transition-all duration-150 ease-in text-lg tablet:text-sm mobile:text-sm laptop:text-base font-bold hover:font-extrabold" title="GitHub Username">
          {user.login}
        </div>
        <div className="text-base tablet:text-xs mobile:text-xs laptop:text-sm" title="Full Name">
